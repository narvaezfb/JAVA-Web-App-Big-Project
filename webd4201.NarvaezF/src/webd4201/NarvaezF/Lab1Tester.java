...
public class Lab1Tester {
	...
	public static void main(String[] args) throws InvalidIdException, InvalidPasswordException, InvalidNameException, ParseException, InvalidUserDataException, SQLException, NotFoundException, NoSuchAlgorithmException {
