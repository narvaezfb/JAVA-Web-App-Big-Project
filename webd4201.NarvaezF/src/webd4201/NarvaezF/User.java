...
////DA static methods, you DO NOT need to be a User object to do these
	/**
	 ...
	 */
	public static User retrieve(long Id) throws NotFoundException, InvalidPasswordException, InvalidNameException, InvalidUserDataException
	{return UserDA.retrieve(Id);}
	
	// DA instance method, you need to be a user object to do these
	/**
	 * 
